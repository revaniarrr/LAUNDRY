        ...
        while (stay) {  /** selama nilai "stay" = true maka program terus berjalan */          
            ...
            if (menu == 1) {
                ...
                for (int i = 0; i < jumlahLaundry; i++) {
                    ...
                    JenisLaundry selectedLaundry = listlaundry.listLaundry[foundLaundry];
                    
                    System.out.print("\nMasukkan jumlah " + 
                            listlaundry.listLaundry[foundLaundry].getJenisLaundry() +
                            " yang dicuci: ");
